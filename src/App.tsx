    ...
    <div className="min-h-screen bg-[#080811] text-slate-100 flex flex-col bg-grid-cyber selection:bg-[#ff007f] selection:text-white relative overflow-x-hidden">
      ...
      <main className="studio-main-dashboard flex-1 w-full max-w-[1600px] xl:max-w-[1850px] 2xl:max-w-[2200px] mx-auto px-2 sm:px-4 xl:px-6 py-2 sm:py-3 flex flex-col gap-3 sm:gap-4">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-3 sm:gap-4 flex-1">
          ...
          <div className="lg:col-span-6 xl:col-span-5 2xl:col-span-5 flex flex-col gap-4">
            <KaraokeDisplay
              lyrics={lyrics}
          ...
          {/* Right: Upload + Library (Expanded on Mac & PC desktop) */}
          <div className="lg:col-span-3 xl:col-span-4 2xl:col-span-4 flex flex-col gap-4">
            <SongLibrary
