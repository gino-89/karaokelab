              ...
              {filteredYouTubeFavorites.length === 0 && filteredSongs.length === 0 ? (
                ...
                <>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex flex-col min-w-0 flex-1">
                          <span
                            className="library-song-title text-xs xl:text-[13px] font-semibold xl:font-bold truncate text-slate-200 group-hover:text-white"
                            title={song.title}
                          >
                            {song.title}
                          </span>
                          <div className="library-song-meta flex items-center gap-1.5 text-[10px] xl:text-[11.5px] font-mono text-slate-400 truncate mt-0.5">
                            ...
                            <span className="hidden xl:inline text-amber-300 font-bold">{song.key || 'Am'}</span>
                            {song.genre && (
                              <span className="text-amber-300 bg-amber-400/10 px-1 rounded text-[9px] xl:text-[9.5px]">
                                {song.genre}
                              </span>
                            )}
                            {song.stems?.instrumentalBlob && (
                              <span className="text-[#00ff9d] bg-[#00ff9d]/15 px-1 rounded text-[9px] xl:text-[9.5px]">
                                ✓ Stems
                              </span>
                            )}
                          </div>
                  ...
                  {filteredYouTubeFavorites.length > 0 && (
                    <div className="p-3 bg-red-950/20 border-t border-red-500/25 flex flex-col gap-2">
                ...
                <>
                  {filteredSongs.length === 0 && filteredYouTubeFavorites.length === 0 ? (
                    ...
                    <>
                      ...
                      {/* 2. YOUTUBE FAVORITES SECTION (BELOW LOCAL SONGS) */}
                      {activeProfile && activeProfile.id !== 'profile_all' && filteredYouTubeFavorites.length > 0 && (
                        <div className="p-3 bg-gradient-to-r from-red-950/30 via-slate-900/90 to-red-950/20 border-t border-red-500/30 flex flex-col gap-2">
                          <div className="flex items-center justify-between">
                            <span className="text-[11px] font-bold text-red-400 font-mono uppercase tracking-wider flex items-center gap-1.5">
                              <Youtube className="w-3.5 h-3.5 fill-current text-red-500" />
