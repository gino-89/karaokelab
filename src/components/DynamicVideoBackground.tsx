...
export const DynamicVideoBackground: React.FC<DynamicVideoBackgroundProps> = ({
  ...
  if (config.videoId && config.videoId !== lastVideoIdRef.current) {
    ...
    embedUrl.current = `https://www.youtube.com/embed/${config.videoId}?autoplay=1&mute=1&controls=0&rel=0&playsinline=1&enablejsapi=1&iv_load_policy=3&loop=1&playlist=${config.videoId}${startParam}`;
  }
