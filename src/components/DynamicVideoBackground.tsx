...
export const DynamicVideoBackground: React.FC<DynamicVideoBackgroundProps> = ({
  ...
  const embedUrl = `https://www.youtube.com/embed/${config.videoId}?autoplay=${isPlaying ? 1 : 0}${startParam}&mute=1&controls=0&rel=0&loop=1&playlist=${config.videoId}&enablejsapi=1&playsinline=1&origin=${origin}`;
